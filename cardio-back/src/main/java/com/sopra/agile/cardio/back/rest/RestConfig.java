...
public class RestConfig {
	...
	public RestConfig(ProjectController projectController, UserController userController, SprintController sprintController, StoryController storyController) {
	...
	private void setupRoutes() {
		...
		get("/api/config/parameters/:key", (req, res) -> projectController.getParameter(req, res, req.params(PARAM_KEY)), new JsonTransformer());
		...
		get("/api/users/:id", (req, res) -> userController.getUser(req, res, req.params(PARAM_ID)), new JsonTransformer());
		...
		get("/api/sprints/:id/data", (req, res) -> sprintController.getSprintData(req, res, req.params(PARAM_ID)), new JsonTransformer());
		get("/api/sprints/:id", (req, res) -> sprintController.getSprint(req, res, req.params(PARAM_ID)), new JsonTransformer());
		...
		get("/api/stories/:id", (req, res) -> storyController.getStory(req, res, req.params(PARAM_ID)), new JsonTransformer());
