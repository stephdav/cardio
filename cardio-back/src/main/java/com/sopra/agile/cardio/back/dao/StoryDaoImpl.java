...
public class StoryDaoImpl implements StoryDao {
	...
	public Story add(Story story) throws CardioTechnicalException {
		...
		try {
			jdbcTemplate.update(SQL_INSERT, story.getDescription(), story.getStatus().toString(), story.getContribution(), story.getEstimate(),
	...
	public Story update(Story story, boolean updateTimestamp) throws CardioTechnicalException {
		...
		try {
			jdbcTemplate.update(sql, story.getDescription(), story.getStatus().toString(), story.getContribution(), story.getEstimate(),
					story.getAssignedUser(), story.getId());
		} catch (Exception ex) {
			throw new CardioTechnicalException(DATABASE_FAILURE, ex);
		}
		return story;
