...
Scenario: Velocity trend
  ...
  Then there is a sprint with dates '2016-01-18' and '2016-01-29', name '2', goal 'sprint 2', commitment '100' and velocity '90' in the list
  When I select sprint '5'
    And I change data of day '10' to '115'
    And I validate data
    And I go on sprints page
  Then there is a sprint with dates '2016-02-29' and '2016-03-11', name '5', goal 'sprint 5', commitment '100' and velocity '115' in the list
  When I go on sprint planning page
